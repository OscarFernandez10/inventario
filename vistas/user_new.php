<!--17 CRUD_ Como GUARDAR DATOS en MySQL desde PHP (USUARIO Cap.1) -->
            ...
            <div class="column"> 
                <div class="control">
                    ...
                    required >
                         ...
                         <!--   LIMITAR A NUMERO Y CIERTOS CARACTERES-->
                  <!--  <input type="text" class="form-control form-control-user" 
                    name="cedula" id="numerodecedula" placeholder="Ingrese N° de Cédula" 
                    onkeyup="this.value=NumText(this.value)" 
                    onchange="this.value=NumText(this.value)" 
                    required=""> -->
